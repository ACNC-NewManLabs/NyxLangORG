...
mod cranelift_impl {
    ...
    use cranelift_codegen::ir::{
        types, AbiParam, Function as ClifFunction, InstBuilder, MemFlags, StackSlotData,
        StackSlotKind,
    };
    ...
    impl JitEngine {
        pub fn new() -> Result<Self, String> {
            ...
            builder.symbol(
                "nyx_jit_pop_truthy",
                crate::runtime::nyx_jit_pop_truthy as *const u8,
            );
            builder.symbol(
                "nyx_jit_push_const",
                crate::runtime::nyx_jit_push_const as *const u8,
            );
            ...
            builder.symbol(
                "nyx_jit_new_array",
                crate::runtime::nyx_jit_new_array as *const u8,
            );
            builder.symbol(
                "nyx_jit_new_obj",
                crate::runtime::nyx_jit_new_obj as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_field",
                crate::runtime::nyx_jit_get_field as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_field_cached",
                crate::runtime::nyx_jit_get_field_cached as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_field",
                crate::runtime::nyx_jit_set_field as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_field_cached",
                crate::runtime::nyx_jit_set_field_cached as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_index",
                crate::runtime::nyx_jit_get_index as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_index_cached",
                crate::runtime::nyx_jit_get_index_cached as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_index",
                crate::runtime::nyx_jit_set_index as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_index_cached",
                crate::runtime::nyx_jit_set_index_cached as *const u8,
            );
            ...
            builder.symbol(
                "nyx_jit_get_global",
                crate::runtime::nyx_jit_get_global as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_global",
                crate::runtime::nyx_jit_set_global as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_global_m",
                crate::runtime::nyx_jit_get_global_m as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_global_m",
                crate::runtime::nyx_jit_set_global_m as *const u8,
            );
            ...
            builder.symbol(
                "nyx_jit_stack_guard",
                crate::runtime::nyx_jit_stack_guard as *const u8,
            );
            builder.symbol(
                "nyx_jit_check_arity",
                crate::runtime::nyx_jit_check_arity as *const u8,
            );
            ...
            builder.symbol(
                "nyx_jit_call_ext",
                crate::runtime::nyx_jit_call_ext as *const u8,
            );
            builder.symbol(
                "nyx_jit_closure",
                crate::runtime::nyx_jit_closure as *const u8,
            );
            builder.symbol(
                "nyx_jit_closure_ref",
                crate::runtime::nyx_jit_closure_ref as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_heap_info",
                crate::runtime::nyx_jit_get_heap_info as *const u8,
            );
            builder.symbol(
                "nyx_jit_get_stack_info",
                crate::runtime::nyx_jit_get_stack_info as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_stack_len",
                crate::runtime::nyx_jit_set_stack_len as *const u8,
            );
            builder.symbol("nyx_jit_pop_n", crate::runtime::nyx_jit_pop_n as *const u8);
            builder.symbol(
                "nyx_jit_push_ic_value",
                crate::runtime::nyx_jit_push_ic_value as *const u8,
            );
            builder.symbol(
                "nyx_jit_push_index_ic_value",
                crate::runtime::nyx_jit_push_index_ic_value as *const u8,
            );
            builder.symbol(
                "nyx_jit_closure_ref_stack",
                crate::runtime::nyx_jit_closure_ref_stack as *const u8,
            );
            builder.symbol(
                "nyx_jit_set_ip",
                crate::runtime::nyx_jit_set_ip as *const u8,
            );
        ...
        pub fn compile(
            ...
            if let Some(existing) = self
                .functions
                .get(&(module_name.to_string(), func_idx, plan))
            {
            ...
            for (ip, instr) in func.instructions.iter().enumerate() {
                ...
                let peek = |builder: &mut FunctionBuilder,
                            depth_off: i64|
                 -> Result<cranelift_codegen::ir::Value, String> {
                    let idx = (current_depth.get() as i64) - 1 - depth_off;
                    if idx < 0 {
                        return Err("Stack underflow in JIT peek".to_string());
                    }
                ...
                match instr.opcode {
                    ...
                    OpCode::JZ | OpCode::JNZ => {
                        ...
                        let then_block = if instr.opcode == OpCode::JZ {
                            blocks[target]
                        } else {
                            blocks[ip + 1]
                        };
                        let else_block = if instr.opcode == OpCode::JZ {
                            blocks[ip + 1]
                        } else {
                            blocks[target]
                        };
                    ...
                    OpCode::RET => {
                        match plan.ret_kind {
                            ...
                            JitRetKind::Bool => {
                                let ret =
                                    pop(&mut builder).unwrap_or_else(|_| match plan.num_kind {
                                        JitNumKind::I64 => builder.ins().iconst(types::I64, 0),
                                        JitNumKind::F64 => builder.ins().f64const(0.0),
                                    });
            ...
            self.functions
                .insert((module_name.to_string(), func_idx, plan), result.clone());
            Ok(result)
        }
        ...
        pub fn compile_vm(
            ...
            let func_id = self
                .module
                .declare_function(
                    &format!("{}_vmjit_{}", module_name, func_idx),
                    Linkage::Local,
                    &sig,
                )
                .map_err(|e| e.to_string())?;
            ...
            let stack_guard = self.import_stub(
                "nyx_jit_stack_guard",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            ...
            let check_arity = self.import_stub(
                "nyx_jit_check_arity",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            ...
            builder
                .ins()
                .brif(combined_err, trap_block, &[], start_block, &[]);
            ...
            let tick = self.import_stub(
                "nyx_jit_tick",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let pop_truthy = self.import_stub(
                "nyx_jit_pop_truthy",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let push_const = self.import_stub(
                "nyx_jit_push_const",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let pushm = self.import_stub(
                "nyx_jit_pushm",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            ...
            let pop =
                self.import_stub("nyx_jit_pop", &[ptr_type], &[types::I64], &mut builder.func)?;
            let dup =
                self.import_stub("nyx_jit_dup", &[ptr_type], &[types::I64], &mut builder.func)?;
            let swap = self.import_stub(
                "nyx_jit_swap",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let load = self.import_stub(
                "nyx_jit_load",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let store = self.import_stub(
                "nyx_jit_store",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            ...
            let add =
                self.import_stub("nyx_jit_add", &[ptr_type], &[types::I64], &mut builder.func)?;
            let sub =
                self.import_stub("nyx_jit_sub", &[ptr_type], &[types::I64], &mut builder.func)?;
            let mul =
                self.import_stub("nyx_jit_mul", &[ptr_type], &[types::I64], &mut builder.func)?;
            let _div =
                self.import_stub("nyx_jit_div", &[ptr_type], &[types::I64], &mut builder.func)?;
            let _neg =
                self.import_stub("nyx_jit_neg", &[ptr_type], &[types::I64], &mut builder.func)?;
            let eq =
                self.import_stub("nyx_jit_eq", &[ptr_type], &[types::I64], &mut builder.func)?;
            let ne =
                self.import_stub("nyx_jit_ne", &[ptr_type], &[types::I64], &mut builder.func)?;
            let lt =
                self.import_stub("nyx_jit_lt", &[ptr_type], &[types::I64], &mut builder.func)?;
            let gt =
                self.import_stub("nyx_jit_gt", &[ptr_type], &[types::I64], &mut builder.func)?;
            let le =
                self.import_stub("nyx_jit_le", &[ptr_type], &[types::I64], &mut builder.func)?;
            let ge =
                self.import_stub("nyx_jit_ge", &[ptr_type], &[types::I64], &mut builder.func)?;
            let new_array = self.import_stub(
                "nyx_jit_new_array",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let new_obj = self.import_stub(
                "nyx_jit_new_obj",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let get_field = self.import_stub(
                "nyx_jit_get_field",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let set_field = self.import_stub(
                "nyx_jit_set_field",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let get_index = self.import_stub(
                "nyx_jit_get_index",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let set_index = self.import_stub(
                "nyx_jit_set_index",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            ...
            let len =
                self.import_stub("nyx_jit_len", &[ptr_type], &[types::I64], &mut builder.func)?;
            let slice = self.import_stub(
                "nyx_jit_slice",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let get_global = self.import_stub(
                "nyx_jit_get_global",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let set_global = self.import_stub(
                "nyx_jit_set_global",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let get_global_m = self.import_stub(
                "nyx_jit_get_global_m",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let set_global_m = self.import_stub(
                "nyx_jit_set_global_m",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let alloc = self.import_stub(
                "nyx_jit_alloc",
                &[ptr_type, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let free = self.import_stub(
                "nyx_jit_free",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            ...
            let ret =
                self.import_stub("nyx_jit_ret", &[ptr_type], &[types::I64], &mut builder.func)?;
            let halt = self.import_stub(
                "nyx_jit_halt",
                &[ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let jit_call = self.import_stub(
                "nyx_jit_call",
                &[ptr_type, types::I32, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let jit_call_ext = self.import_stub(
                "nyx_jit_call_ext",
                &[ptr_type, types::I32, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let jit_closure = self.import_stub(
                "nyx_jit_closure",
                &[ptr_type, types::I32, types::I32],
                &[types::I64],
                &mut builder.func,
            )?;
            let jit_closure_ref = self.import_stub(
                "nyx_jit_closure_ref",
                &[ptr_type, types::I32, types::I32, ptr_type],
                &[types::I64],
                &mut builder.func,
            )?;
            let jit_closure_ref_stack = self.import_stub(
                "nyx_jit_closure_ref_stack",
                &[ptr_type, types::I32, types::I32],
                &[types::I64],
                &mut builder.func,
            ...
            for (ip, instr) in func.instructions.iter().enumerate() {
                ...
                builder
                    .ins()
                    .brif(tick_err, trap_block, &[], after_tick, &[]);
                ...
                match instr.opcode {
                    ...
                    OpCode::PUSH => {
                        ...
                        builder
                            .ins()
                            .brif(is_err, trap_block, &[], blocks[ip + 1], &[]);
                        continue;
                    }
                    OpCode::PushM => {
                        let idx = *instr
                    ...
                    OpCode::ADD => {
                        let stack_info_fn = self.import_stub(
                            "nyx_jit_get_stack_info",
                            &[ptr_type],
                            &[ptr_type, types::I64],
                            &mut builder.func,
                        ...
                        let enough_stack =
                            builder
                                .ins()
                                .icmp_imm(IntCC::UnsignedGreaterThanOrEqual, stack_len, 2);
                        let hit_label = builder.create_block();
                        let miss_label = builder.create_block();
                        builder
                            .ins()
                            .brif(enough_stack, hit_label, &[], miss_label, &[]);
                        ...
                        builder
                            .ins()
                            .brif(both_int, fast_path, &[], miss_label, &[]);
                        ...
                        let set_stack_len_fn = self.import_stub(
                            "nyx_jit_set_stack_len",
                            &[ptr_type, types::I64],
                            &[types::I64],
                            &mut builder.func,
                    ...
                    OpCode::EQ => {
                        ...
                        let set_stack_len = self.import_stub(
                            "nyx_jit_set_stack_len",
                            &[ptr_type, types::I64],
                            &[types::I64],
                            &mut builder.func,
                    ...
                    OpCode::BNOT => {
                        ...
                        builder.seal_block(miss_label);
                        builder.switch_to_block(miss_label);
                        let bnot_stub = self.import_stub(
                            "nyx_jit_bnot",
                            &[ptr_type],
                            &[types::I64],
                            &mut builder.func,
                    ...
                    OpCode::MOD => {
                        ...
                        builder
                            .ins()
                            .brif(not_zero, zero_check_label, &[], miss_label, &[]);
                    ...
                    OpCode::BAND | OpCode::BOR | OpCode::BXOR => {
                        ...
                        let stub = match instr.opcode {
                            OpCode::BAND => self.import_stub(
                                "nyx_jit_band",
                                &[ptr_type],
                                &[types::I64],
                                &mut builder.func,
                            )?,
                            OpCode::BOR => self.import_stub(
                                "nyx_jit_bor",
                                &[ptr_type],
                                &[types::I64],
                                &mut builder.func,
                            )?,
                            OpCode::BXOR => self.import_stub(
                                "nyx_jit_bxor",
                                &[ptr_type],
                                &[types::I64],
                                &mut builder.func,
                        ...
                        if ip > 0 && func.instructions[ip - 1].opcode == OpCode::PUSH {
                            ...
                            if let Some(Value::String(s)) = func.constants.get(c_idx) {
                                ...
                                if let Some(ref ic_buffer) = attr_ic_buffer {
                                    ...
                                    let get_heap_info = self.import_stub(
                                        "nyx_jit_get_heap_info",
                                        &[ptr_type],
                                        &[ptr_type, types::I64],
                                        &mut builder.func,
                                    )?;
                                    let get_stack_info = self.import_stub(
                                        "nyx_jit_get_stack_info",
                                        &[ptr_type],
                                        &[ptr_type, types::I64],
                                        &mut builder.func,
                                    )?;
                                    let push_ic_value = self.import_stub(
                                        "nyx_jit_push_ic_value",
                                        &[ptr_type, ptr_type],
                                        &[types::I64],
                                        &mut builder.func,
                                    )?;
                                    let get_field_cached = self.import_stub(
                                        "nyx_jit_get_field_cached",
                                    ...
                                    let enough_stack = builder.ins().icmp_imm(
                                    ...
                                    let target_val_addr =
                                        builder.ins().iadd(stack_ptr, target_offset);
                                    let target_tag = builder.ins().load(
                                        types::I64,
                                        MemFlags::new(),
                                        target_val_addr,
                                        0,
                                    ...
                                    let is_pointer =
                                        builder.ins().icmp_imm(IntCC::Equal, target_tag, 10);
                                    ...
                                    let target_ptr_val = builder.ins().load(
                                        ptr_type,
                                        MemFlags::new(),
                                        target_val_addr,
                                        8,
                                    ...
                                    let ic_target_ptr =
                                        builder.ins().load(ptr_type, MemFlags::new(), ic_val, 0);
                                    let ptr_match = builder.ins().icmp(
                                        IntCC::Equal,
                                        target_ptr_val,
                                        ic_target_ptr,
                                    );
                                    ...
                                    let slot_ptr_addr =
                                        builder.ins().iadd(heap_slots_ptr, slot_ptr_offset);
                                    ...
                                    let slot_exists =
                                        builder.ins().icmp_imm(IntCC::NotEqual, slot_ptr, 0);
                                    ...
                                    let slot_gen = builder.ins().load(
                                        types::I64,
                                        MemFlags::new(),
                                        slot_ptr,
                                        0,
                                    );
                                    let slot_ver = builder.ins().load(
                                        types::I64,
                                        MemFlags::new(),
                                        slot_ptr,
                                        8,
                                    ...
                                    let ic_gen =
                                        builder.ins().load(types::I64, MemFlags::new(), ic_val, 8);
                                    let ic_ver =
                                        builder.ins().load(types::I64, MemFlags::new(), ic_val, 16);

                                    let gen_match =
                                        builder.ins().icmp(IntCC::Equal, slot_gen, ic_gen);
                                    let ver_match =
                                        builder.ins().icmp(IntCC::Equal, slot_ver, ic_ver);
                                    ...
                                    let _ = builder.ins().call(pop, &[rt_param]);
                                    let push_res =
                                        builder.ins().call(push_ic_value, &[rt_param, ic_val]);
                                    let push_val = builder.inst_results(push_res)[0];
                                    let is_push_err =
                                        builder.ins().icmp_imm(IntCC::Equal, push_val, -1);
                                    builder.ins().brif(
                                        is_push_err,
                                        trap_block,
                                        &[],
                        ...
                        if ip > 0 && func.instructions[ip - 1].opcode == OpCode::PUSH {
                            ...
                            if let Some(Value::String(s)) = func.constants.get(c_idx) {
                                if let Some(ref ic_buffer) = attr_ic_buffer {
                                    ...
                                    let set_field_cached = self.import_stub(
                                        "nyx_jit_set_field_cached",
                                        &[ptr_type, ptr_type, ptr_type, ptr_type],
                                        &[types::I64],
                                        &mut builder.func,
                                    ...
                                    let is_err_miss =
                                        builder.ins().icmp_imm(IntCC::Equal, res_miss, -1);
                                    builder.ins().brif(
                                        is_err_miss,
                                        trap_block,
                                        &[],
                        ...
                        if ip > 0 && func.instructions[ip - 1].opcode == OpCode::PUSH {
                            ...
                            if let Some(Value::Int(idx)) = func.constants.get(c_idx) {
                                if let Some(ref ic_buffer) = index_ic_buffer {
                                    ...
                                    let push_index_ic_value = self.import_stub(
                                        "nyx_jit_push_index_ic_value",
                                        &[ptr_type, ptr_type],
                                        &[types::I64],
                                        &mut builder.func,
                                    )?;
                                    let get_index_cached = self.import_stub(
                                        "nyx_jit_get_index_cached",
                                    ...
                                    let idx_match =
                                        builder.ins().icmp(IntCC::Equal, idx_val, ic_index);
                                    ...
                                    let ic_gen =
                                        builder.ins().load(types::I64, MemFlags::new(), ic_val, 16);
                                    let ic_ver =
                                        builder.ins().load(types::I64, MemFlags::new(), ic_val, 24);
                                    ...
                                    let _ = builder.ins().call(pop, &[rt_param]);
                                    let _ = builder.ins().call(pop, &[rt_param]);
                                    let push_res = builder
                                        .ins()
                                        .call(push_index_ic_value, &[rt_param, ic_val]);
                                    let push_val = builder.inst_results(push_res)[0];
                                    let is_push_err =
                                        builder.ins().icmp_imm(IntCC::Equal, push_val, -1);
                                    builder.ins().brif(
                                    ...
                                    let res = builder
                                        .ins()
                                        .call(get_index_cached, &[rt_param, ic_val, idx_val]);
                                    let res_val = builder.inst_results(res)[0];
                                    let is_err = builder.ins().icmp_imm(IntCC::Equal, res_val, -1);
                                    builder.ins().brif(is_err, trap_block, &[], next_label, &[]);
                        ...
                        if ip > 0 && func.instructions[ip - 1].opcode == OpCode::PUSH {
                            ...
                            if let Some(Value::Int(idx)) = func.constants.get(c_idx) {
                                if let Some(ref ic_buffer) = index_ic_buffer {
                                    ...
                                    let set_index_cached = self.import_stub(
                                        "nyx_jit_set_index_cached",
                                        &[ptr_type, ptr_type, types::I64],
                                        &[types::I64],
                                        &mut builder.func,
                                    ...
                                    let res = builder
                                        .ins()
                                        .call(set_index_cached, &[rt_param, ic_val, idx_val]);
                                    let res_val = builder.inst_results(res)[0];
                                    let is_err = builder.ins().icmp_imm(IntCC::Equal, res_val, -1);
                                    builder.ins().brif(is_err, trap_block, &[], next_label, &[]);
                                    ...
                                    builder.seal_block(miss_label);
                                    builder.switch_to_block(miss_label);
                                    let res_miss = builder
                                        .ins()
                                        .call(set_index_cached, &[rt_param, ic_val, idx_val]);
                                    let res_val_miss = builder.inst_results(res_miss)[0];
                                    let is_err_miss =
                                        builder.ins().icmp_imm(IntCC::Equal, res_val_miss, -1);
                                    builder.ins().brif(
                                        is_err_miss,
                                        trap_block,
                                        &[],
                    ...
                    OpCode::JMP => {
                        let target = *instr
                            .operands
                            .get(0)
                            .ok_or_else(|| "JMP missing operand".to_string())?
                            as usize;
                    ...
                    OpCode::JZ | OpCode::JNZ => {
                        let target =
                            *instr.operands.get(0).ok_or("JZ/JNZ missing target")? as usize;
                        if target >= func.instructions.len() {
                            return Err("Invalid jump target".to_string());
                        }
                        ...
                        builder
                            .ins()
                            .brif(is_false, then_block, &[], else_block, &[]);
                        ...
                        builder
                            .ins()
                            .brif(is_false_slow, then_block, &[], else_block, &[]);
                        continue;
                    }
                    OpCode::RET => {
                    ...
                    OpCode::CALL => {
                        ...
                        builder
                            .ins()
                            .brif(is_err, trap_block, &[], yield_block, &[]);
                        continue;
                    }
                    OpCode::CallExt => {
                        ...
                        let res =
                            call2_i32(&mut builder, jit_call_ext, rt_param, name_idx, num_args);
                        let is_err = builder.ins().icmp_imm(IntCC::Equal, res, -1);
                        builder
                            .ins()
                            .brif(is_err, trap_block, &[], blocks[ip + 1], &[]);
                    ...
                    OpCode::CLOSURE => {
                        ...
                        let num_upvalues = *instr
                            .operands
                            .get(1)
                            .ok_or("CLOSURE missing num_upvalues")?;
                        let res =
                            call2_i32(&mut builder, jit_closure, rt_param, func_idx, num_upvalues);
                        let is_err = builder.ins().icmp_imm(IntCC::Equal, res, -1);
                        builder
                            .ins()
                            .brif(is_err, trap_block, &[], blocks[ip + 1], &[]);
                    ...
                    OpCode::ClosureRef => {
                        let func_idx =
                            *instr.operands.get(0).ok_or("ClosureRef missing func_idx")?;
                        let num_upvalues = *instr
                            .operands
                            .get(1)
                            .ok_or("ClosureRef missing num_upvalues")?
                            as usize;
                        ...
                        for (i, &idx) in upvalue_indices.iter().enumerate() {
                            ...
                            builder
                                .ins()
                                .store(MemFlags::new(), val, addr, (i * 4) as i32);
                        }

                        let res = call3_i32_ptr(
                            &mut builder,
                            jit_closure_ref,
                            rt_param,
                            func_idx,
                    ...
                    OpCode::ClosureRefStack => {
                        let func_idx = *instr
                            .operands
                            .get(0)
                            .ok_or("ClosureRefStack missing func_idx")?;
                        let num_upvalues = *instr
                            .operands
                            .get(1)
                            .ok_or("ClosureRefStack missing num_upvalues")?;
                        let res = call2_i32(
                            &mut builder,
                            jit_closure_ref_stack,
                            rt_param,
                            func_idx,
                            num_upvalues,
                        );
                    ...
                    _ => {
                        return Err(format!(
                            "Unsupported opcode for VM-aware JIT: {:?}",
                            instr.opcode
                        ))
                    }
                }
            ...
            self.vm_functions
                .insert((module_name.to_string(), func_idx), result.clone());
            Ok(result)
        }
    }
            ...
            match args.len() {
                ...
                2 => {
                    let f: unsafe extern "C" fn(i64, i64) -> i64 =
                        std::mem::transmute(jit.func_ptr);
                    f(args[0], args[1])
                }
                3 => {
                ...
                9 => {
                    let f: unsafe extern "C" fn(
                        ...
                        i64,
                        i64,
                    ) -> i64 = std::mem::transmute(jit.func_ptr);
                    f(
                        args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7],
                        args[8],
                    )
            ...
            match args.len() {
                ...
                9 => {
                    let f: unsafe extern "C" fn(
                        ...
                        f64,
                        f64,
                    ) -> f64 = std::mem::transmute(jit.func_ptr);
                    f(
                        args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7],
                        args[8],
                    )
    ...
    pub fn call_bool_from_f64(jit: &JitResult, args: &[f64]) -> i64 {
        ...
        unsafe {
            match args.len() {
                ...
                7 => {
                    let f: unsafe extern "C" fn(f64, f64, f64, f64, f64, f64, f64) -> i64 =
                        std::mem::transmute(jit.func_ptr);
                    f(
                        args[0], args[1], args[2], args[3], args[4], args[5], args[6],
                    )
                ...
                8 => {
                    let f: unsafe extern "C" fn(f64, f64, f64, f64, f64, f64, f64, f64) -> i64 =
                        std::mem::transmute(jit.func_ptr);
                    f(
                        args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7],
                    )
    ...
    pub unsafe fn call_vm(jit: &VmJitResult, rt: *mut crate::runtime::VmRuntime, ip: i32) -> i64 {
        let f: unsafe extern "C" fn(*mut crate::runtime::VmRuntime, i32) -> i64 =
            std::mem::transmute(jit.func_ptr);
        f(rt, ip)
    }
...
pub use cranelift_impl::{
    call_bool_from_f64, call_f64, call_i64, call_vm, compile, compile_vm, new_engine, plan,
    vm_plan, Engine,
};
...
mod nojit_impl {
    ...
    pub unsafe fn call_vm(
        _jit: &VmJitResult,
        _rt: *mut crate::runtime::VmRuntime,
        _ip: i32,
    ) -> i64 {
        -1
    }
