...
pub mod keyboard {
    ...
    impl KeyCode {
        ...
        // --- Function keys ---
        pub const F1: u8  = 0x3B; pub const F2: u8  = 0x3C;
        pub const F3: u8  = 0x3D; pub const F4: u8  = 0x3E;
        pub const F5: u8  = 0x3F; pub const F6: u8  = 0x40;
        pub const F7: u8  = 0x41; pub const F8: u8  = 0x42;
        pub const F9: u8  = 0x43; pub const F10: u8 = 0x44;
        pub const F11: u8 = 0x57; pub const F12: u8 = 0x58;
        // --- Arrow keys (extended) ---
        ...
        // --- Alphanumeric ---
        pub const A: u8 = 0x1E; pub const B: u8 = 0x30;
        pub const C: u8 = 0x2E; pub const D: u8 = 0x20;
        pub const E: u8 = 0x12; pub const F: u8 = 0x21;
        pub const G: u8 = 0x22; pub const H: u8 = 0x23;
        pub const I: u8 = 0x17; pub const J: u8 = 0x24;
        pub const K: u8 = 0x25; pub const L: u8 = 0x26;
        pub const M: u8 = 0x32; pub const N: u8 = 0x31;
        pub const O: u8 = 0x18; pub const P: u8 = 0x19;
        pub const Q: u8 = 0x10; pub const R: u8 = 0x13;
        pub const S: u8 = 0x1F; pub const T: u8 = 0x14;
        pub const U: u8 = 0x16; pub const V: u8 = 0x2F;
        pub const W: u8 = 0x11; pub const X: u8 = 0x2D;
        pub const Y: u8 = 0x15; pub const Z: u8 = 0x2C;
        pub const N0: u8 = 0x0B; pub const N1: u8 = 0x02;
        pub const N2: u8 = 0x03; pub const N3: u8 = 0x04;
        pub const N4: u8 = 0x05; pub const N5: u8 = 0x06;
        pub const N6: u8 = 0x07; pub const N7: u8 = 0x08;
        pub const N8: u8 = 0x09; pub const N9: u8 = 0x0A;
    }
    ...
    pub fn scancode_to_ascii(sc: u8) -> Option<char> {
        ...
        table.iter().find(|(code, _)| *code == sc).map(|(_, ch)| *ch)
    }
