...
impl StorageIntelligence {
    ...
    pub fn select_compression_codec(&self, sparsity: f64, null_count: usize, total_rows: usize) -> &str {
...
mod tests {
    ...
    fn test_tier_migration_logic() {
        ...
        assert_eq!(store.run_auto_tier_migration(2, 500), StorageTier::HotMemory);
    ...
    fn test_smart_compression_heuristics() {
        ...
        assert_eq!(store.select_compression_codec(0.9, 0, 1000), "RLE_Bitmap_Hybrid");
        // Large dense data gets Zstd Dictionary
        assert_eq!(store.select_compression_codec(0.1, 0, 500_000), "Zstd_Dictionary");
    }
}
